...
00000000 <boot>:
   ...
   4:	800f8f93          	addi	t6,t6,-2048 # 1800 <__stack_init+0x8fc>
...
00000130 <UART_init>:
 ...
 150:	60078793          	addi	a5,a5,1536 # 9600 <__stack_init+0x86fc>
 ...
 170:	58078793          	addi	a5,a5,1408 # 2580 <__stack_init+0x167c>
 ...
 194:	b0078793          	addi	a5,a5,-1280 # 4b00 <__stack_init+0x3bfc>
 ...
 1b8:	10078793          	addi	a5,a5,256 # e100 <__stack_init+0xd1fc>
 ...
 1d8:	20078793          	addi	a5,a5,512 # 1c200 <__stack_init+0x1b2fc>
 ...
 218:	80078793          	addi	a5,a5,-2048 # 70800 <__VMEM_END+0x30400>
...
000004e8 <UARTvprintf>:
 ...
 5ac:	f2878793          	addi	a5,a5,-216 # f28 <__stack_init+0x24>
 ...
 724:	f1c78513          	addi	a0,a5,-228 # f1c <__stack_init+0x18>
 ...
 8b0:	f0878713          	addi	a4,a5,-248 # f08 <__stack_init+0x4>
 ...
 934:	f2078513          	addi	a0,a5,-224 # f20 <__stack_init+0x1c>
...
00000ad8 <ISR5>:
 ...
 b64:	204000ef          	jal	ra,d68 <ISR5_uart>
...
00000bf4 <ISR6>:
 ...
 c80:	268000ef          	jal	ra,ee8 <ISR6_addr_exception>
...
00000d10 <main>:
 ...
 d28:	000207b7          	lui	a5,0x20
 d2c:	0bc78793          	addi	a5,a5,188 # 200bc <Y>
 d30:	0807a503          	lw	a0,128(a5)
 d34:	02000713          	li	a4,32
 d38:	00800693          	li	a3,8
 d3c:	000407b7          	lui	a5,0x40
 d40:	00078613          	mv	a2,a5
 d44:	000207b7          	lui	a5,0x20
 d48:	00078593          	mv	a1,a5
 d4c:	c85ff0ef          	jal	ra,9d0 <mlp32>
 d50:	00000793          	li	a5,0
 d54:	00078513          	mv	a0,a5
 d58:	01c12083          	lw	ra,28(sp)
 d5c:	01812403          	lw	s0,24(sp)
 d60:	02010113          	addi	sp,sp,32
 d64:	00008067          	ret

00000d68 <ISR5_uart>:
 d68:	ff010113          	addi	sp,sp,-16
 d6c:	00112623          	sw	ra,12(sp)
 d70:	00812423          	sw	s0,8(sp)
 d74:	01010413          	addi	s0,sp,16
 d78:	5f1007b7          	lui	a5,0x5f100
 d7c:	6f078793          	addi	a5,a5,1776 # 5f1006f0 <__VREG_END+0x5f0806f0>
 d80:	0007c783          	lbu	a5,0(a5)
 d84:	0ff7f713          	andi	a4,a5,255
 d88:	8ae18623          	sb	a4,-1876(gp) # 200ac <read_val>
 d8c:	8ac1c783          	lbu	a5,-1876(gp) # 200ac <read_val>
 d90:	00078513          	mv	a0,a5
 d94:	dc4ff0ef          	jal	ra,358 <UARTCharPut>
 d98:	8a41a783          	lw	a5,-1884(gp) # 200a4 <recv_counter>
 d9c:	00178713          	addi	a4,a5,1
 da0:	8ae1a223          	sw	a4,-1884(gp) # 200a4 <recv_counter>
 da4:	8b51c783          	lbu	a5,-1867(gp) # 200b5 <start_read>
 da8:	0c079a63          	bnez	a5,e7c <ISR5_uart+0x114>
 dac:	8b41c783          	lbu	a5,-1868(gp) # 200b4 <header_count>
 db0:	02079663          	bnez	a5,ddc <ISR5_uart+0x74>
 db4:	8ac1c703          	lbu	a4,-1876(gp) # 200ac <read_val>
 db8:	0aa00793          	li	a5,170
 dbc:	00f71a63          	bne	a4,a5,dd0 <ISR5_uart+0x68>
 dc0:	00100713          	li	a4,1
 dc4:	8ae18a23          	sb	a4,-1868(gp) # 200b4 <header_count>
 dc8:	8a018aa3          	sb	zero,-1867(gp) # 200b5 <start_read>
 dcc:	0dc0006f          	j	ea8 <ISR5_uart+0x140>
 dd0:	8a018a23          	sb	zero,-1868(gp) # 200b4 <header_count>
 dd4:	8a018aa3          	sb	zero,-1867(gp) # 200b5 <start_read>
 dd8:	0d00006f          	j	ea8 <ISR5_uart+0x140>
 ddc:	8b41c703          	lbu	a4,-1868(gp) # 200b4 <header_count>
 de0:	00100793          	li	a5,1
 de4:	02f71663          	bne	a4,a5,e10 <ISR5_uart+0xa8>
 de8:	8ac1c703          	lbu	a4,-1876(gp) # 200ac <read_val>
 dec:	05500793          	li	a5,85
 df0:	00f71a63          	bne	a4,a5,e04 <ISR5_uart+0x9c>
 df4:	00200713          	li	a4,2
 df8:	8ae18a23          	sb	a4,-1868(gp) # 200b4 <header_count>
 dfc:	8a018aa3          	sb	zero,-1867(gp) # 200b5 <start_read>
 e00:	0a80006f          	j	ea8 <ISR5_uart+0x140>
 e04:	8a018a23          	sb	zero,-1868(gp) # 200b4 <header_count>
 e08:	8a018aa3          	sb	zero,-1867(gp) # 200b5 <start_read>
 e0c:	09c0006f          	j	ea8 <ISR5_uart+0x140>
 e10:	8b41c703          	lbu	a4,-1868(gp) # 200b4 <header_count>
 e14:	00200793          	li	a5,2
 e18:	02f71663          	bne	a4,a5,e44 <ISR5_uart+0xdc>
 e1c:	8ac1c703          	lbu	a4,-1876(gp) # 200ac <read_val>
 e20:	0bb00793          	li	a5,187
 e24:	00f71a63          	bne	a4,a5,e38 <ISR5_uart+0xd0>
 e28:	00300713          	li	a4,3
 e2c:	8ae18a23          	sb	a4,-1868(gp) # 200b4 <header_count>
 e30:	8a018aa3          	sb	zero,-1867(gp) # 200b5 <start_read>
 e34:	0740006f          	j	ea8 <ISR5_uart+0x140>
 e38:	8a018a23          	sb	zero,-1868(gp) # 200b4 <header_count>
 e3c:	8a018aa3          	sb	zero,-1867(gp) # 200b5 <start_read>
 e40:	0680006f          	j	ea8 <ISR5_uart+0x140>
 e44:	8b41c703          	lbu	a4,-1868(gp) # 200b4 <header_count>
 e48:	00300793          	li	a5,3
 e4c:	04f71e63          	bne	a4,a5,ea8 <ISR5_uart+0x140>
 e50:	8ac1c703          	lbu	a4,-1876(gp) # 200ac <read_val>
 e54:	06600793          	li	a5,102
 e58:	00f71c63          	bne	a4,a5,e70 <ISR5_uart+0x108>
 e5c:	00400713          	li	a4,4
 e60:	8ae18a23          	sb	a4,-1868(gp) # 200b4 <header_count>
 e64:	00100713          	li	a4,1
 e68:	8ae18aa3          	sb	a4,-1867(gp) # 200b5 <start_read>
 e6c:	03c0006f          	j	ea8 <ISR5_uart+0x140>
 e70:	8a018a23          	sb	zero,-1868(gp) # 200b4 <header_count>
 e74:	8a018aa3          	sb	zero,-1867(gp) # 200b5 <start_read>
 e78:	0300006f          	j	ea8 <ISR5_uart+0x140>
 e7c:	8ac1c783          	lbu	a5,-1876(gp) # 200ac <read_val>
 e80:	00078713          	mv	a4,a5
 e84:	8a81a783          	lw	a5,-1880(gp) # 200a8 <recv_num_counter>
 e88:	01071713          	slli	a4,a4,0x10
 e8c:	93c18693          	addi	a3,gp,-1732 # 2013c <img_buf>
 e90:	00279793          	slli	a5,a5,0x2
 e94:	00f687b3          	add	a5,a3,a5
 e98:	00e7a023          	sw	a4,0(a5)
 e9c:	8a81a783          	lw	a5,-1880(gp) # 200a8 <recv_num_counter>
 ea0:	00178713          	addi	a4,a5,1
 ea4:	8ae1a423          	sw	a4,-1880(gp) # 200a8 <recv_num_counter>
 ea8:	8a81a703          	lw	a4,-1880(gp) # 200a8 <recv_num_counter>
 eac:	01000793          	li	a5,16
 eb0:	02f71063          	bne	a4,a5,ed0 <ISR5_uart+0x168>
 eb4:	00100713          	li	a4,1
 eb8:	8ae1a823          	sw	a4,-1872(gp) # 200b0 <pflag>
 ebc:	8a01a423          	sw	zero,-1880(gp) # 200a8 <recv_num_counter>
 ec0:	8a01a223          	sw	zero,-1884(gp) # 200a4 <recv_counter>
 ec4:	8a018aa3          	sb	zero,-1867(gp) # 200b5 <start_read>
 ec8:	8a018a23          	sb	zero,-1868(gp) # 200b4 <header_count>
 ecc:	0080006f          	j	ed4 <ISR5_uart+0x16c>
 ed0:	8a01a823          	sw	zero,-1872(gp) # 200b0 <pflag>
 ed4:	00000013          	nop
 ed8:	00c12083          	lw	ra,12(sp)
 edc:	00812403          	lw	s0,8(sp)
 ee0:	01010113          	addi	sp,sp,16
 ee4:	00008067          	ret

00000ee8 <ISR6_addr_exception>:
 ee8:	ff010113          	addi	sp,sp,-16
 eec:	00812623          	sw	s0,12(sp)
 ef0:	01010413          	addi	s0,sp,16
 ef4:	00000013          	nop
 ef8:	00c12403          	lw	s0,12(sp)
 efc:	01010113          	addi	sp,sp,16
 f00:	00008067          	ret

00000f04 <__stack_init>:
 f04:	0003fffc                                ....
