...
00000194 <OUTER_LOOP>:
 ...
 198:	00729e13          	slli	t3,t0,0x7
 19c:	01c58733          	add	a4,a1,t3
 1a0:	00060793          	mv	a5,a2

000001a4 <INNER_LOOP>:
 1a4:	08000e13          	li	t3,128
 ...
 1c4:	0207e207          	vle32.v	v4,(a5)
 1c8:	0204e407          	vle32.v	v8,(s1)
 1cc:	02096607          	vle32.v	v12,(s2)
 1d0:	0209e807          	vle32.v	v16,(s3)
 1d4:	b64a6a57          	vmacc.vx	v20,s4,v4
 1d8:	b68aea57          	vmacc.vx	v20,s5,v8
 1dc:	b6cb6a57          	vmacc.vx	v20,s6,v12
 1e0:	b70bea57          	vmacc.vx	v20,s7,v16
 1e4:	20000e13          	li	t3,512
 ...
 1fc:	02056a27          	vse32.v	v20,(a0)
 200:	97606b57          	vmul.vx	v22,v22,zero
 204:	97806c57          	vmul.vx	v24,v24,zero
 208:	97a06d57          	vmul.vx	v26,v26,zero
 20c:	97c06e57          	vmul.vx	v28,v28,zero
 210:	97c06e57          	vmul.vx	v28,v28,zero
 214:	97c06e57          	vmul.vx	v28,v28,zero
 218:	97c06e57          	vmul.vx	v28,v28,zero
 21c:	08050513          	addi	a0,a0,128
