...
00000130 <UART_init>:
 ...
 218:	80078793          	addi	a5,a5,-2048 # 70800 <__VMEM_END+0x30000>
...
00000d10 <main>:
 ...
 d28:	8dc18793          	addi	a5,gp,-1828 # 200dc <Y>
 d2c:	0807a503          	lw	a0,128(a5)
 d30:	02000713          	li	a4,32
 d34:	01000693          	li	a3,16
...
00000d64 <ISR5_uart>:
 ...
 d84:	8ce18623          	sb	a4,-1844(gp) # 200cc <read_val>
 d88:	8cc1c783          	lbu	a5,-1844(gp) # 200cc <read_val>
 d8c:	00078513          	mv	a0,a5
 d90:	dc8ff0ef          	jal	ra,358 <UARTCharPut>
 d94:	8c41a783          	lw	a5,-1852(gp) # 200c4 <recv_counter>
 d98:	00178713          	addi	a4,a5,1
 d9c:	8ce1a223          	sw	a4,-1852(gp) # 200c4 <recv_counter>
 da0:	8d51c783          	lbu	a5,-1835(gp) # 200d5 <start_read>
 da4:	0c079a63          	bnez	a5,e78 <ISR5_uart+0x114>
 da8:	8d41c783          	lbu	a5,-1836(gp) # 200d4 <header_count>
 dac:	02079663          	bnez	a5,dd8 <ISR5_uart+0x74>
 db0:	8cc1c703          	lbu	a4,-1844(gp) # 200cc <read_val>
 db4:	0aa00793          	li	a5,170
 db8:	00f71a63          	bne	a4,a5,dcc <ISR5_uart+0x68>
 dbc:	00100713          	li	a4,1
 dc0:	8ce18a23          	sb	a4,-1836(gp) # 200d4 <header_count>
 dc4:	8c018aa3          	sb	zero,-1835(gp) # 200d5 <start_read>
 dc8:	0dc0006f          	j	ea4 <ISR5_uart+0x140>
 dcc:	8c018a23          	sb	zero,-1836(gp) # 200d4 <header_count>
 dd0:	8c018aa3          	sb	zero,-1835(gp) # 200d5 <start_read>
 dd4:	0d00006f          	j	ea4 <ISR5_uart+0x140>
 dd8:	8d41c703          	lbu	a4,-1836(gp) # 200d4 <header_count>
 ddc:	00100793          	li	a5,1
 de0:	02f71663          	bne	a4,a5,e0c <ISR5_uart+0xa8>
 de4:	8cc1c703          	lbu	a4,-1844(gp) # 200cc <read_val>
 de8:	05500793          	li	a5,85
 dec:	00f71a63          	bne	a4,a5,e00 <ISR5_uart+0x9c>
 df0:	00200713          	li	a4,2
 df4:	8ce18a23          	sb	a4,-1836(gp) # 200d4 <header_count>
 df8:	8c018aa3          	sb	zero,-1835(gp) # 200d5 <start_read>
 dfc:	0a80006f          	j	ea4 <ISR5_uart+0x140>
 e00:	8c018a23          	sb	zero,-1836(gp) # 200d4 <header_count>
 e04:	8c018aa3          	sb	zero,-1835(gp) # 200d5 <start_read>
 e08:	09c0006f          	j	ea4 <ISR5_uart+0x140>
 e0c:	8d41c703          	lbu	a4,-1836(gp) # 200d4 <header_count>
 e10:	00200793          	li	a5,2
 e14:	02f71663          	bne	a4,a5,e40 <ISR5_uart+0xdc>
 e18:	8cc1c703          	lbu	a4,-1844(gp) # 200cc <read_val>
 e1c:	0bb00793          	li	a5,187
 e20:	00f71a63          	bne	a4,a5,e34 <ISR5_uart+0xd0>
 e24:	00300713          	li	a4,3
 e28:	8ce18a23          	sb	a4,-1836(gp) # 200d4 <header_count>
 e2c:	8c018aa3          	sb	zero,-1835(gp) # 200d5 <start_read>
 e30:	0740006f          	j	ea4 <ISR5_uart+0x140>
 e34:	8c018a23          	sb	zero,-1836(gp) # 200d4 <header_count>
 e38:	8c018aa3          	sb	zero,-1835(gp) # 200d5 <start_read>
 e3c:	0680006f          	j	ea4 <ISR5_uart+0x140>
 e40:	8d41c703          	lbu	a4,-1836(gp) # 200d4 <header_count>
 e44:	00300793          	li	a5,3
 e48:	04f71e63          	bne	a4,a5,ea4 <ISR5_uart+0x140>
 e4c:	8cc1c703          	lbu	a4,-1844(gp) # 200cc <read_val>
 e50:	06600793          	li	a5,102
 e54:	00f71c63          	bne	a4,a5,e6c <ISR5_uart+0x108>
 e58:	00400713          	li	a4,4
 e5c:	8ce18a23          	sb	a4,-1836(gp) # 200d4 <header_count>
 e60:	00100713          	li	a4,1
 e64:	8ce18aa3          	sb	a4,-1835(gp) # 200d5 <start_read>
 e68:	03c0006f          	j	ea4 <ISR5_uart+0x140>
 e6c:	8c018a23          	sb	zero,-1836(gp) # 200d4 <header_count>
 e70:	8c018aa3          	sb	zero,-1835(gp) # 200d5 <start_read>
 e74:	0300006f          	j	ea4 <ISR5_uart+0x140>
 e78:	8cc1c783          	lbu	a5,-1844(gp) # 200cc <read_val>
 e7c:	00078713          	mv	a4,a5
 e80:	8c81a783          	lw	a5,-1848(gp) # 200c8 <recv_num_counter>
 e84:	01071713          	slli	a4,a4,0x10
 e88:	95c18693          	addi	a3,gp,-1700 # 2015c <img_buf>
 e8c:	00279793          	slli	a5,a5,0x2
 e90:	00f687b3          	add	a5,a3,a5
 e94:	00e7a023          	sw	a4,0(a5)
 e98:	8c81a783          	lw	a5,-1848(gp) # 200c8 <recv_num_counter>
 e9c:	00178713          	addi	a4,a5,1
 ea0:	8ce1a423          	sw	a4,-1848(gp) # 200c8 <recv_num_counter>
 ea4:	8c81a703          	lw	a4,-1848(gp) # 200c8 <recv_num_counter>
 ea8:	01000793          	li	a5,16
 eac:	02f71063          	bne	a4,a5,ecc <ISR5_uart+0x168>
 eb0:	00100713          	li	a4,1
 eb4:	8ce1a823          	sw	a4,-1840(gp) # 200d0 <pflag>
 eb8:	8c01a423          	sw	zero,-1848(gp) # 200c8 <recv_num_counter>
 ebc:	8c01a223          	sw	zero,-1852(gp) # 200c4 <recv_counter>
 ec0:	8c018aa3          	sb	zero,-1835(gp) # 200d5 <start_read>
 ec4:	8c018a23          	sb	zero,-1836(gp) # 200d4 <header_count>
 ec8:	0080006f          	j	ed0 <ISR5_uart+0x16c>
 ecc:	8c01a823          	sw	zero,-1840(gp) # 200d0 <pflag>
 ed0:	00000013          	nop
