...
00000130 <UART_init>:
 ...
 218:	80078793          	addi	a5,a5,-2048 # 70800 <__VMEM_END+0x2e800>
...
00000d10 <main>:
 ...
 d28:	99c18793          	addi	a5,gp,-1636 # 2019c <Y>
 d2c:	0807a503          	lw	a0,128(a5)
 d30:	02000713          	li	a4,32
 d34:	04000693          	li	a3,64
...
00000d64 <ISR5_uart>:
 ...
 d84:	98e18623          	sb	a4,-1652(gp) # 2018c <read_val>
 d88:	98c1c783          	lbu	a5,-1652(gp) # 2018c <read_val>
 d8c:	00078513          	mv	a0,a5
 d90:	dc8ff0ef          	jal	ra,358 <UARTCharPut>
 d94:	9841a783          	lw	a5,-1660(gp) # 20184 <recv_counter>
 d98:	00178713          	addi	a4,a5,1
 d9c:	98e1a223          	sw	a4,-1660(gp) # 20184 <recv_counter>
 da0:	9951c783          	lbu	a5,-1643(gp) # 20195 <start_read>
 da4:	0c079a63          	bnez	a5,e78 <ISR5_uart+0x114>
 da8:	9941c783          	lbu	a5,-1644(gp) # 20194 <header_count>
 dac:	02079663          	bnez	a5,dd8 <ISR5_uart+0x74>
 db0:	98c1c703          	lbu	a4,-1652(gp) # 2018c <read_val>
 db4:	0aa00793          	li	a5,170
 db8:	00f71a63          	bne	a4,a5,dcc <ISR5_uart+0x68>
 dbc:	00100713          	li	a4,1
 dc0:	98e18a23          	sb	a4,-1644(gp) # 20194 <header_count>
 dc4:	98018aa3          	sb	zero,-1643(gp) # 20195 <start_read>
 dc8:	0dc0006f          	j	ea4 <ISR5_uart+0x140>
 dcc:	98018a23          	sb	zero,-1644(gp) # 20194 <header_count>
 dd0:	98018aa3          	sb	zero,-1643(gp) # 20195 <start_read>
 dd4:	0d00006f          	j	ea4 <ISR5_uart+0x140>
 dd8:	9941c703          	lbu	a4,-1644(gp) # 20194 <header_count>
 ddc:	00100793          	li	a5,1
 de0:	02f71663          	bne	a4,a5,e0c <ISR5_uart+0xa8>
 de4:	98c1c703          	lbu	a4,-1652(gp) # 2018c <read_val>
 de8:	05500793          	li	a5,85
 dec:	00f71a63          	bne	a4,a5,e00 <ISR5_uart+0x9c>
 df0:	00200713          	li	a4,2
 df4:	98e18a23          	sb	a4,-1644(gp) # 20194 <header_count>
 df8:	98018aa3          	sb	zero,-1643(gp) # 20195 <start_read>
 dfc:	0a80006f          	j	ea4 <ISR5_uart+0x140>
 e00:	98018a23          	sb	zero,-1644(gp) # 20194 <header_count>
 e04:	98018aa3          	sb	zero,-1643(gp) # 20195 <start_read>
 e08:	09c0006f          	j	ea4 <ISR5_uart+0x140>
 e0c:	9941c703          	lbu	a4,-1644(gp) # 20194 <header_count>
 e10:	00200793          	li	a5,2
 e14:	02f71663          	bne	a4,a5,e40 <ISR5_uart+0xdc>
 e18:	98c1c703          	lbu	a4,-1652(gp) # 2018c <read_val>
 e1c:	0bb00793          	li	a5,187
 e20:	00f71a63          	bne	a4,a5,e34 <ISR5_uart+0xd0>
 e24:	00300713          	li	a4,3
 e28:	98e18a23          	sb	a4,-1644(gp) # 20194 <header_count>
 e2c:	98018aa3          	sb	zero,-1643(gp) # 20195 <start_read>
 e30:	0740006f          	j	ea4 <ISR5_uart+0x140>
 e34:	98018a23          	sb	zero,-1644(gp) # 20194 <header_count>
 e38:	98018aa3          	sb	zero,-1643(gp) # 20195 <start_read>
 e3c:	0680006f          	j	ea4 <ISR5_uart+0x140>
 e40:	9941c703          	lbu	a4,-1644(gp) # 20194 <header_count>
 e44:	00300793          	li	a5,3
 e48:	04f71e63          	bne	a4,a5,ea4 <ISR5_uart+0x140>
 e4c:	98c1c703          	lbu	a4,-1652(gp) # 2018c <read_val>
 e50:	06600793          	li	a5,102
 e54:	00f71c63          	bne	a4,a5,e6c <ISR5_uart+0x108>
 e58:	00400713          	li	a4,4
 e5c:	98e18a23          	sb	a4,-1644(gp) # 20194 <header_count>
 e60:	00100713          	li	a4,1
 e64:	98e18aa3          	sb	a4,-1643(gp) # 20195 <start_read>
 e68:	03c0006f          	j	ea4 <ISR5_uart+0x140>
 e6c:	98018a23          	sb	zero,-1644(gp) # 20194 <header_count>
 e70:	98018aa3          	sb	zero,-1643(gp) # 20195 <start_read>
 e74:	0300006f          	j	ea4 <ISR5_uart+0x140>
 e78:	98c1c783          	lbu	a5,-1652(gp) # 2018c <read_val>
 e7c:	00078713          	mv	a4,a5
 e80:	9881a783          	lw	a5,-1656(gp) # 20188 <recv_num_counter>
 e84:	01071713          	slli	a4,a4,0x10
 e88:	a1c18693          	addi	a3,gp,-1508 # 2021c <img_buf>
 e8c:	00279793          	slli	a5,a5,0x2
 e90:	00f687b3          	add	a5,a3,a5
 e94:	00e7a023          	sw	a4,0(a5)
 e98:	9881a783          	lw	a5,-1656(gp) # 20188 <recv_num_counter>
 e9c:	00178713          	addi	a4,a5,1
 ea0:	98e1a423          	sw	a4,-1656(gp) # 20188 <recv_num_counter>
 ea4:	9881a703          	lw	a4,-1656(gp) # 20188 <recv_num_counter>
 ea8:	01000793          	li	a5,16
 eac:	02f71063          	bne	a4,a5,ecc <ISR5_uart+0x168>
 eb0:	00100713          	li	a4,1
 eb4:	98e1a823          	sw	a4,-1648(gp) # 20190 <pflag>
 eb8:	9801a423          	sw	zero,-1656(gp) # 20188 <recv_num_counter>
 ebc:	9801a223          	sw	zero,-1660(gp) # 20184 <recv_counter>
 ec0:	98018aa3          	sb	zero,-1643(gp) # 20195 <start_read>
 ec4:	98018a23          	sb	zero,-1644(gp) # 20194 <header_count>
 ec8:	0080006f          	j	ed0 <ISR5_uart+0x16c>
 ecc:	9801a823          	sw	zero,-1648(gp) # 20190 <pflag>
 ed0:	00000013          	nop
