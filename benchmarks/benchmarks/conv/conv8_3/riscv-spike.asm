...
00000000 <boot>:
       ...
       4:	800f8f93          	addi	t6,t6,-2048 # 1800 <__stack_init+0x6f4>
...
00000130 <UART_init>:
     ...
     150:	60078793          	addi	a5,a5,1536 # 9600 <__stack_init+0x84f4>
     ...
     170:	58078793          	addi	a5,a5,1408 # 2580 <__stack_init+0x1474>
     ...
     194:	b0078793          	addi	a5,a5,-1280 # 4b00 <__stack_init+0x39f4>
     ...
     1b8:	10078793          	addi	a5,a5,256 # e100 <__stack_init+0xcff4>
     ...
     1d8:	20078793          	addi	a5,a5,512 # 1c200 <__stack_init+0x1b0f4>
     ...
     238:	78478793          	addi	a5,a5,1924 # 17d784 <__VMEM_END+0x7c2e0>
...
000004e8 <UARTvprintf>:
     ...
     5ac:	13078793          	addi	a5,a5,304 # 1130 <__stack_init+0x24>
     ...
     724:	12478513          	addi	a0,a5,292 # 1124 <__stack_init+0x18>
     ...
     8b0:	11078713          	addi	a4,a5,272 # 1110 <__stack_init+0x4>
     ...
     934:	12878513          	addi	a0,a5,296 # 1128 <__stack_init+0x1c>
...
00000c0c <ISR5>:
     ...
     c98:	2d8000ef          	jal	ra,f70 <ISR5_uart>
...
00000d28 <ISR6>:
     ...
     db4:	33c000ef          	jal	ra,10f0 <ISR6_addr_exception>
...
00000e44 <main>:
     ...
     eec:	001017b7          	lui	a5,0x101
     ef0:	b8078713          	addi	a4,a5,-1152 # 100b80 <Y>
     ...
     f2c:	001017b7          	lui	a5,0x101
     f30:	4a07a783          	lw	a5,1184(a5) # 1014a0 <err_count>
     f34:	00178713          	addi	a4,a5,1
     f38:	001017b7          	lui	a5,0x101
     f3c:	4ae7a023          	sw	a4,1184(a5) # 1014a0 <err_count>
     f40:	fec42783          	lw	a5,-20(s0)
     f44:	00178793          	addi	a5,a5,1
     f48:	fef42623          	sw	a5,-20(s0)
     f4c:	fec42703          	lw	a4,-20(s0)
     f50:	23f00793          	li	a5,575
     f54:	f4e7dee3          	bge	a5,a4,eb0 <main+0x6c>
...
00000f70 <ISR5_uart>:
     ...
     f78:	00812423          	sw	s0,8(sp)
     f7c:	01010413          	addi	s0,sp,16
     f80:	5f1007b7          	lui	a5,0x5f100
     f84:	6f078793          	addi	a5,a5,1776 # 5f1006f0 <__VREG_END+0x5ef806f0>
     f88:	0007c783          	lbu	a5,0(a5)
     f8c:	0ff7f713          	andi	a4,a5,255
     f90:	9ae18a23          	sb	a4,-1612(gp) # 201b4 <read_val>
     f94:	9b41c783          	lbu	a5,-1612(gp) # 201b4 <read_val>
     f98:	00078513          	mv	a0,a5
     f9c:	bbcff0ef          	jal	ra,358 <UARTCharPut>
     fa0:	9ac1a783          	lw	a5,-1620(gp) # 201ac <recv_counter>
     fa4:	00178713          	addi	a4,a5,1
     fa8:	9ae1a623          	sw	a4,-1620(gp) # 201ac <recv_counter>
     fac:	9bd1c783          	lbu	a5,-1603(gp) # 201bd <start_read>
     fb0:	0c079a63          	bnez	a5,1084 <ISR5_uart+0x114>
     fb4:	9bc1c783          	lbu	a5,-1604(gp) # 201bc <header_count>
     fb8:	02079663          	bnez	a5,fe4 <ISR5_uart+0x74>
     fbc:	9b41c703          	lbu	a4,-1612(gp) # 201b4 <read_val>
     fc0:	0aa00793          	li	a5,170
     fc4:	00f71a63          	bne	a4,a5,fd8 <ISR5_uart+0x68>
     fc8:	00100713          	li	a4,1
     fcc:	9ae18e23          	sb	a4,-1604(gp) # 201bc <header_count>
     fd0:	9a018ea3          	sb	zero,-1603(gp) # 201bd <start_read>
     fd4:	0dc0006f          	j	10b0 <ISR5_uart+0x140>
     fd8:	9a018e23          	sb	zero,-1604(gp) # 201bc <header_count>
     fdc:	9a018ea3          	sb	zero,-1603(gp) # 201bd <start_read>
     fe0:	0d00006f          	j	10b0 <ISR5_uart+0x140>
     fe4:	9bc1c703          	lbu	a4,-1604(gp) # 201bc <header_count>
     fe8:	00100793          	li	a5,1
     fec:	02f71663          	bne	a4,a5,1018 <ISR5_uart+0xa8>
     ff0:	9b41c703          	lbu	a4,-1612(gp) # 201b4 <read_val>
     ff4:	05500793          	li	a5,85
     ff8:	00f71a63          	bne	a4,a5,100c <ISR5_uart+0x9c>
     ffc:	00200713          	li	a4,2
    1000:	9ae18e23          	sb	a4,-1604(gp) # 201bc <header_count>
    1004:	9a018ea3          	sb	zero,-1603(gp) # 201bd <start_read>
    1008:	0a80006f          	j	10b0 <ISR5_uart+0x140>
    100c:	9a018e23          	sb	zero,-1604(gp) # 201bc <header_count>
    1010:	9a018ea3          	sb	zero,-1603(gp) # 201bd <start_read>
    1014:	09c0006f          	j	10b0 <ISR5_uart+0x140>
    1018:	9bc1c703          	lbu	a4,-1604(gp) # 201bc <header_count>
    101c:	00200793          	li	a5,2
    1020:	02f71663          	bne	a4,a5,104c <ISR5_uart+0xdc>
    1024:	9b41c703          	lbu	a4,-1612(gp) # 201b4 <read_val>
    1028:	0bb00793          	li	a5,187
    102c:	00f71a63          	bne	a4,a5,1040 <ISR5_uart+0xd0>
    1030:	00300713          	li	a4,3
    1034:	9ae18e23          	sb	a4,-1604(gp) # 201bc <header_count>
    1038:	9a018ea3          	sb	zero,-1603(gp) # 201bd <start_read>
    103c:	0740006f          	j	10b0 <ISR5_uart+0x140>
    1040:	9a018e23          	sb	zero,-1604(gp) # 201bc <header_count>
    1044:	9a018ea3          	sb	zero,-1603(gp) # 201bd <start_read>
    1048:	0680006f          	j	10b0 <ISR5_uart+0x140>
    104c:	9bc1c703          	lbu	a4,-1604(gp) # 201bc <header_count>
    1050:	00300793          	li	a5,3
    1054:	04f71e63          	bne	a4,a5,10b0 <ISR5_uart+0x140>
    1058:	9b41c703          	lbu	a4,-1612(gp) # 201b4 <read_val>
    105c:	06600793          	li	a5,102
    1060:	00f71c63          	bne	a4,a5,1078 <ISR5_uart+0x108>
    1064:	00400713          	li	a4,4
    1068:	9ae18e23          	sb	a4,-1604(gp) # 201bc <header_count>
    106c:	00100713          	li	a4,1
    1070:	9ae18ea3          	sb	a4,-1603(gp) # 201bd <start_read>
    1074:	03c0006f          	j	10b0 <ISR5_uart+0x140>
    1078:	9a018e23          	sb	zero,-1604(gp) # 201bc <header_count>
    107c:	9a018ea3          	sb	zero,-1603(gp) # 201bd <start_read>
    1080:	0300006f          	j	10b0 <ISR5_uart+0x140>
    1084:	9b41c783          	lbu	a5,-1612(gp) # 201b4 <read_val>
    1088:	00078713          	mv	a4,a5
    108c:	9b01a783          	lw	a5,-1616(gp) # 201b0 <recv_num_counter>
    1090:	01071713          	slli	a4,a4,0x10
    1094:	9c418693          	addi	a3,gp,-1596 # 201c4 <img_buf>
    1098:	00279793          	slli	a5,a5,0x2
    109c:	00f687b3          	add	a5,a3,a5
    10a0:	00e7a023          	sw	a4,0(a5)
    10a4:	9b01a783          	lw	a5,-1616(gp) # 201b0 <recv_num_counter>
    10a8:	00178713          	addi	a4,a5,1
    10ac:	9ae1a823          	sw	a4,-1616(gp) # 201b0 <recv_num_counter>
    10b0:	9b01a703          	lw	a4,-1616(gp) # 201b0 <recv_num_counter>
    10b4:	04000793          	li	a5,64
    10b8:	02f71063          	bne	a4,a5,10d8 <ISR5_uart+0x168>
    10bc:	00100713          	li	a4,1
    10c0:	9ae1ac23          	sw	a4,-1608(gp) # 201b8 <pflag>
    10c4:	9a01a823          	sw	zero,-1616(gp) # 201b0 <recv_num_counter>
    10c8:	9a01a623          	sw	zero,-1620(gp) # 201ac <recv_counter>
    10cc:	9a018ea3          	sb	zero,-1603(gp) # 201bd <start_read>
    10d0:	9a018e23          	sb	zero,-1604(gp) # 201bc <header_count>
    10d4:	0080006f          	j	10dc <ISR5_uart+0x16c>
    10d8:	9a01ac23          	sw	zero,-1608(gp) # 201b8 <pflag>
    10dc:	00000013          	nop
...
000010f0 <ISR6_addr_exception>:
    10f0:	ff010113          	addi	sp,sp,-16
    10f4:	00812623          	sw	s0,12(sp)
    10f8:	01010413          	addi	s0,sp,16
    10fc:	00000013          	nop
    1100:	00c12403          	lw	s0,12(sp)
    1104:	01010113          	addi	sp,sp,16
    1108:	00008067          	ret

0000110c <__stack_init>:
    110c:	000feffc                                ....
