...
00000000 <boot>:
       ...
       4:	800f8f93          	addi	t6,t6,-2048 # 1800 <__stack_init+0x6f0>
...
00000130 <UART_init>:
     ...
     150:	60078793          	addi	a5,a5,1536 # 9600 <__stack_init+0x84f0>
     ...
     170:	58078793          	addi	a5,a5,1408 # 2580 <__stack_init+0x1470>
     ...
     194:	b0078793          	addi	a5,a5,-1280 # 4b00 <__stack_init+0x39f0>
     ...
     1b8:	10078793          	addi	a5,a5,256 # e100 <__stack_init+0xcff0>
     ...
     1d8:	20078793          	addi	a5,a5,512 # 1c200 <__stack_init+0x1b0f0>
     ...
     1f8:	40078793          	addi	a5,a5,1024 # 38400 <__BSS_END__+0x17b3c>
     ...
     218:	80078793          	addi	a5,a5,-2048 # 70800 <__BSS_END__+0x4ff3c>
     ...
     238:	78478793          	addi	a5,a5,1924 # 17d784 <__VMEM_END+0x772e0>
     ...
     258:	bc278793          	addi	a5,a5,-1086 # bebc2 <__BSS_END__+0x9e2fe>
...
000004e8 <UARTvprintf>:
     ...
     5ac:	13478793          	addi	a5,a5,308 # 1134 <__stack_init+0x24>
     ...
     724:	12878513          	addi	a0,a5,296 # 1128 <__stack_init+0x18>
     ...
     8b0:	11478713          	addi	a4,a5,276 # 1114 <__stack_init+0x4>
     ...
     934:	12c78513          	addi	a0,a5,300 # 112c <__stack_init+0x1c>
...
00000d28 <ISR6>:
     ...
     db4:	340000ef          	jal	ra,10f4 <ISR6_addr_exception>
...
00000e44 <main>:
     ...
     eec:	001037b7          	lui	a5,0x103
     ef0:	38078713          	addi	a4,a5,896 # 103380 <Y>
     ...
     f2c:	001067b7          	lui	a5,0x106
     f30:	4a07a783          	lw	a5,1184(a5) # 1064a0 <err_count>
     f34:	00178713          	addi	a4,a5,1
     f38:	001067b7          	lui	a5,0x106
     f3c:	4ae7a023          	sw	a4,1184(a5) # 1064a0 <err_count>
     f40:	fec42783          	lw	a5,-20(s0)
     f44:	00178793          	addi	a5,a5,1
     f48:	fef42623          	sw	a5,-20(s0)
     f4c:	fec42703          	lw	a4,-20(s0)
     f50:	000017b7          	lui	a5,0x1
     f54:	c3f78793          	addi	a5,a5,-961 # c3f <ISR5+0x33>
...
00000f74 <ISR5_uart>:
     ...
     f94:	cae18a23          	sb	a4,-844(gp) # 204b4 <read_val>
     f98:	cb41c783          	lbu	a5,-844(gp) # 204b4 <read_val>
     f9c:	00078513          	mv	a0,a5
     fa0:	bb8ff0ef          	jal	ra,358 <UARTCharPut>
     fa4:	cac1a783          	lw	a5,-852(gp) # 204ac <recv_counter>
     fa8:	00178713          	addi	a4,a5,1
     fac:	cae1a623          	sw	a4,-852(gp) # 204ac <recv_counter>
     fb0:	cbd1c783          	lbu	a5,-835(gp) # 204bd <start_read>
     fb4:	0c079a63          	bnez	a5,1088 <ISR5_uart+0x114>
     fb8:	cbc1c783          	lbu	a5,-836(gp) # 204bc <header_count>
     fbc:	02079663          	bnez	a5,fe8 <ISR5_uart+0x74>
     fc0:	cb41c703          	lbu	a4,-844(gp) # 204b4 <read_val>
     fc4:	0aa00793          	li	a5,170
     fc8:	00f71a63          	bne	a4,a5,fdc <ISR5_uart+0x68>
     fcc:	00100713          	li	a4,1
     fd0:	cae18e23          	sb	a4,-836(gp) # 204bc <header_count>
     fd4:	ca018ea3          	sb	zero,-835(gp) # 204bd <start_read>
     fd8:	0dc0006f          	j	10b4 <ISR5_uart+0x140>
     fdc:	ca018e23          	sb	zero,-836(gp) # 204bc <header_count>
     fe0:	ca018ea3          	sb	zero,-835(gp) # 204bd <start_read>
     fe4:	0d00006f          	j	10b4 <ISR5_uart+0x140>
     fe8:	cbc1c703          	lbu	a4,-836(gp) # 204bc <header_count>
     fec:	00100793          	li	a5,1
     ff0:	02f71663          	bne	a4,a5,101c <ISR5_uart+0xa8>
     ff4:	cb41c703          	lbu	a4,-844(gp) # 204b4 <read_val>
     ff8:	05500793          	li	a5,85
     ffc:	00f71a63          	bne	a4,a5,1010 <ISR5_uart+0x9c>
    1000:	00200713          	li	a4,2
    1004:	cae18e23          	sb	a4,-836(gp) # 204bc <header_count>
    1008:	ca018ea3          	sb	zero,-835(gp) # 204bd <start_read>
    100c:	0a80006f          	j	10b4 <ISR5_uart+0x140>
    1010:	ca018e23          	sb	zero,-836(gp) # 204bc <header_count>
    1014:	ca018ea3          	sb	zero,-835(gp) # 204bd <start_read>
    1018:	09c0006f          	j	10b4 <ISR5_uart+0x140>
    101c:	cbc1c703          	lbu	a4,-836(gp) # 204bc <header_count>
    1020:	00200793          	li	a5,2
    1024:	02f71663          	bne	a4,a5,1050 <ISR5_uart+0xdc>
    1028:	cb41c703          	lbu	a4,-844(gp) # 204b4 <read_val>
    102c:	0bb00793          	li	a5,187
    1030:	00f71a63          	bne	a4,a5,1044 <ISR5_uart+0xd0>
    1034:	00300713          	li	a4,3
    1038:	cae18e23          	sb	a4,-836(gp) # 204bc <header_count>
    103c:	ca018ea3          	sb	zero,-835(gp) # 204bd <start_read>
    1040:	0740006f          	j	10b4 <ISR5_uart+0x140>
    1044:	ca018e23          	sb	zero,-836(gp) # 204bc <header_count>
    1048:	ca018ea3          	sb	zero,-835(gp) # 204bd <start_read>
    104c:	0680006f          	j	10b4 <ISR5_uart+0x140>
    1050:	cbc1c703          	lbu	a4,-836(gp) # 204bc <header_count>
    1054:	00300793          	li	a5,3
    1058:	04f71e63          	bne	a4,a5,10b4 <ISR5_uart+0x140>
    105c:	cb41c703          	lbu	a4,-844(gp) # 204b4 <read_val>
    1060:	06600793          	li	a5,102
    1064:	00f71c63          	bne	a4,a5,107c <ISR5_uart+0x108>
    1068:	00400713          	li	a4,4
    106c:	cae18e23          	sb	a4,-836(gp) # 204bc <header_count>
    1070:	00100713          	li	a4,1
    1074:	cae18ea3          	sb	a4,-835(gp) # 204bd <start_read>
    1078:	03c0006f          	j	10b4 <ISR5_uart+0x140>
    107c:	ca018e23          	sb	zero,-836(gp) # 204bc <header_count>
    1080:	ca018ea3          	sb	zero,-835(gp) # 204bd <start_read>
    1084:	0300006f          	j	10b4 <ISR5_uart+0x140>
    1088:	cb41c783          	lbu	a5,-844(gp) # 204b4 <read_val>
    108c:	00078713          	mv	a4,a5
    1090:	cb01a783          	lw	a5,-848(gp) # 204b0 <recv_num_counter>
    1094:	01071713          	slli	a4,a4,0x10
    1098:	cc418693          	addi	a3,gp,-828 # 204c4 <img_buf>
    109c:	00279793          	slli	a5,a5,0x2
    10a0:	00f687b3          	add	a5,a3,a5
    10a4:	00e7a023          	sw	a4,0(a5)
    10a8:	cb01a783          	lw	a5,-848(gp) # 204b0 <recv_num_counter>
    10ac:	00178713          	addi	a4,a5,1
    10b0:	cae1a823          	sw	a4,-848(gp) # 204b0 <recv_num_counter>
    10b4:	cb01a703          	lw	a4,-848(gp) # 204b0 <recv_num_counter>
    10b8:	10000793          	li	a5,256
    10bc:	02f71063          	bne	a4,a5,10dc <ISR5_uart+0x168>
    10c0:	00100713          	li	a4,1
    10c4:	cae1ac23          	sw	a4,-840(gp) # 204b8 <pflag>
    10c8:	ca01a823          	sw	zero,-848(gp) # 204b0 <recv_num_counter>
    10cc:	ca01a623          	sw	zero,-852(gp) # 204ac <recv_counter>
    10d0:	ca018ea3          	sb	zero,-835(gp) # 204bd <start_read>
    10d4:	ca018e23          	sb	zero,-836(gp) # 204bc <header_count>
    10d8:	0080006f          	j	10e0 <ISR5_uart+0x16c>
    10dc:	ca01ac23          	sw	zero,-840(gp) # 204b8 <pflag>
    10e0:	00000013          	nop
...
000010f4 <ISR6_addr_exception>:
    10f4:	ff010113          	addi	sp,sp,-16
    10f8:	00812623          	sw	s0,12(sp)
    10fc:	01010413          	addi	s0,sp,16
    1100:	00000013          	nop
    1104:	00c12403          	lw	s0,12(sp)
    1108:	01010113          	addi	sp,sp,16
    110c:	00008067          	ret

00001110 <__stack_init>:
    1110:	000feffc                                ....
